...
import { CategroyCreator } from "./category-creator"
...
export const PaperUploader = ({
  ...
  const createPaper = useMutation(api.files.createPaper)
  ...
  const onSubmit = async () => {
    ...
    formData.append("category", paperData.categoryId)
    ...
    >
      <DialogTrigger asChild>
        ...
        >
          ...
          {showTitle && <p className="ml-1">Upload Paper</p>}
        </Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      ...
                      <CategroyCreator handleCategoryCreate={handleCategoryCreate} />
                      for the paper
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
